...
<head>
<meta charset="utf-8">
<title>PayPal Pro payment gateway - Platinum Bookkeeping and Tax</title>
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if (data.status == 1) {
                        ...
                        $('#orderInfo').html('<p>Order has been submitted successfully. Transction ID : <span>#'+data.orderID+'</span></p>');
                    }else{
                        $('#paymentSection').slideUp('slow');
                        $('#orderInfo').slideDown('slow');
...
<div class="card-payment">
    ...
    <form method="post" id="paymentForm">
          <h4>Payable amount: $<?=$_REQUEST['amount'];?> CAD</h4>
          <ul>
              <input type="hidden" name="card_type" id="card_type" value=""/>
			  <input type="hidden" name="amount" id="amount" value="<?=$_REQUEST['amount'];?>"/>
			  <input type="hidden" name="InvoiceNumber" id="InvoiceNumber" value="<?=$_REQUEST['amount'];?>"/>
			  <input type="hidden" name="CompanyName" id="CompanyName" value="<?=$_REQUEST['CompanyName'];?>"/>
              <li>
                  ...
                  <small class="help">This payment supports Visa, American Express, Maestro, MasterCard and Discover.</small>              </li>
              ...
              <li>
                  ...
                  <input type="text" placeholder="Enter Name" id="name_on_card" name="name_on_card">
              </li>
